...
class CategoryController extends Controller
{
    ...
    public function store( Request $request)
    {
        ...
        if ($categories->save()) {
            return redirect('index/category')->with('success','Category information successfully saved.');
         }
         else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($categories->save()) {
           return redirect('index/category')->with('success','Category information successfully updated.');
        }
        else{
