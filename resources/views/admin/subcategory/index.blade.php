                        ...
                        <tbody>
                            ...
                            @foreach ($subcategories as $category)
                                <tr>
                                    ...
                                    <td style="width: 80px">
                                        <a href="{{route('edit.subcategory',$category->id)}}" class="btn btn-info btn-xs"> <i class="fa fa-edit"></i> </a>
                                        <a href="{{route('delete.subcategory',$category->id)}}" class="btn btn-danger btn-xs"> <i class="fa fa-trash-alt"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
